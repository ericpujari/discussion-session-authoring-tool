...
const BLOCKED_TERMS = [
  // -- sexual content --
  'sex', 'porn', 'nude', 'naked', 'penis', 'vagina', 'vulva', 'clitoris',
  'labia', 'boob', 'boobs', 'breast', 'breasts', 'nipple', 'nipples',
  'testicle', 'testicles', 'scrotum', 'anus', 'butt', 'buttocks', 'pubic',
  'foreskin', 'condom', 'orgasm', 'masturbate', 'masturbation', 'erotic',
  'fetish', 'anal', 'oral sex', 'blowjob', 'handjob', 'cum', 'cumshot',
  'semen', 'ejaculate', 'ejaculation', 'horny', 'sexy', 'strip club',
  'stripper', 'prostitute', 'hooker', 'incest', 'bdsm', 'bondage', 'dildo',
  'vibrator', 'threesome', 'orgy',

  // -- profanity / slurs --
  'fuck', 'shit', 'ass', 'bitch', 'bastard', 'asshole', 'dick', 'cock',
  'pussy', 'cunt', 'whore', 'slut', 'damn', 'hell', 'crap', 'piss', 'pissed',
